...
'https://metropark.fra1.digitaloceanspaces.com'
...
# STATIC
# ------------------------
STATICFILES_STORAGE = "django_ecommerce_01.utils.storages.StaticRootS3Boto3Storage"
COLLECTFAST_STRATEGY = "collectfast.strategies.boto3.Boto3Strategy"
STATIC_URL = f"https://{AWS_LOCATION}/static/"
# MEDIA
# ------------------------------------------------------------------------------
DEFAULT_FILE_STORAGE = "django_ecommerce_01.utils.storages.MediaRootS3Boto3Storage"
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="E-commerce-Django <noreply@example.com>",
)
