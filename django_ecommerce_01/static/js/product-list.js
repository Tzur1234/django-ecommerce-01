...
function insertProductUI(data) {
    ...
    data.forEach(product => {
      ...
      card.classList.add('col-lg-3', 'col-md-6', 'col-sm-12', 'pb-1');
      card.innerHTML = `
...
function editColorSizeVariation(product){
    // This function add the available sizes and colors of the product to the form
    const forms = document.querySelectorAll('#product-detail .container-fluid .row form');
    const SizeForm = forms[0];
    const ColorForm = forms[1];
    ...
    // add colors
    product.color_variation.forEach(function(color, index) {
